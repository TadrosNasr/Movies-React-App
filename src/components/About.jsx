    ...
    return (
        <div style={{height: '100vh', marginTop:50}}>
            <div className="mx-auto col-12 col-lg-7">
                <img className='border border-2 border-warning rounded-2 w-100 w-lg-50 mt-4' src='https://wallpapersmug.com/download/2560x1440/6e645c/captain-marvel-movie-poster.jpg'></img>
            </div>
